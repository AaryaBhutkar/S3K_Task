...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      <h1 className="text-3xl font-bold text-purple-800 mb-6 text-center">HOMEPAGE</h1>
      
      <div className="flex flex-row gap-4 justify-center w-full max-w-6xl">
        <div className={`flex-1 bg-white rounded-lg shadow-lg p-8 transform transition-all duration-500 ${
        ...
        <div className={`flex-1 bg-white rounded-lg shadow-lg p-8 transform transition-all duration-500 delay-150 ${
          isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'
        }`}>
          <div className="bg-gray-50 p-4 rounded-lg h-full">
        ...
        <div className={`flex-1 bg-white rounded-lg shadow-lg p-8 transform transition-all duration-500 delay-300 ${
          isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'
        }`}>
          <div className="bg-gray-50 p-4 rounded-lg h-full">
      ...
      <div className={`mt-8 transition-all duration-500 delay-450 ${
        isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'
      }`}>
        <Link 
          to="/dashboard" 
